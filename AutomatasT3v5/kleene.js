...
export class LambdaNFA extends FSA {
    /**
...
export class NFA extends LambdaNFA {
    /**
...
export class DFA2 extends NFA {
    ...
    */
    minimize() {
        ...
        let partitionGivesEquivalenceexport;
        do {
            partitionGivesEquivalenceexport= true;
                ...
                for (let c of sigma) {
                    for (let j = 0; j < partitionLength; j++) {
                        ...
                        if (goToToStateSet.size > 0
                            ...
                            partitionGivesEquivalenceexport = false;
        ...
        } while (!partitionGivesEquivalenceexport);
        ...
        return new DFA2(sigma, partition,
